...
use App\Api\Dto\V1\CreateTransferRequest;
...
final class TransferController extends AbstractController
{
    ...
    #[Route('', name: 'api_v1_transfer_create', methods: ['POST'])]
    public function create(
        ...
        return $this->json($this->mapper->fromCreateResult($result), $statusCode);
    }

    #[Route('', name: 'api_v1_transfer_list', methods: ['GET'])]
    ...
    #[Route('/recent', name: 'api_v1_transfer_recent', methods: ['GET'])]
    public function recent(#[MapQueryString] ListTransfersRequest $query): JsonResponse
    {
        ...
        return $this->json(array_merge(
            $this->mapper->fromPaginatedResult($result),
            ['periodDays' => $days],
        ));
    }

    #[Route('/{reference}', name: 'api_v1_transfer_show', methods: ['GET'])]
    public function show(string $reference): JsonResponse
    {
        ...
        return $this->json($this->mapper->fromTransfer($transfer));
    }
}
